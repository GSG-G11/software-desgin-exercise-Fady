...
//generic eventlistner function
const eventListner = (element, event, callback) => {
  document.querySelector(element).addEventListener(event, callback);
};

eventListner("#form-unanswered", "submit", function (e) {
  e.preventDefault();
...
eventListner("#form-answerers", "submit", function (e) {
  e.preventDefault();
